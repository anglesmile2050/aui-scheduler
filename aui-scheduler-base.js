...
var Lang = A.Lang,
    ...
    CSS_SCHEDULER_EVENT_ISFIXED = getCN('scheduler-event', 'isfixed'),//modifed by qy
    CSS_SCHEDULER_EVENT_ISDONE = getCN('scheduler-event', 'isdone'),//modified by qy
...
var SchedulerEvent = A.Component.create({
    ...
    PROPAGATE_ATTRS: ['allDay', 'startDate', 'endDate', 'content', 'color', 'colorBrightnessFactor',
        'colorSaturationFactor', 'titleDateFormat', 'visible', 'disabled','isFixed','isDone'],
    ...
    prototype: {
        ...
        bindUI: function() {
            ...
            instance.after({
                ...
                isFixedChange: instance._afterIsFixedChange, //modified by qy
                isDoneChange: instance._afterIsDoneChange, //modified by qy
        ...
        syncUI: function() {
            ...
            //modified by qy
            instance._uiSetIsFixed(
                instance.get('isFixed'));

            //modified by qy                
            instance._uiSetIsDone(
                instance.get('isDone'));
        ...
        //modified by qy
        _afterIsFixedChange: function(event) {
            var instance = this;

            instance._uiSetIsFixed(event.newVal);
        },
        
        //modified by qy
        _afterIsDoneChange: function(event) {
            var instance = this;

            instance._uiSetIsDone(event.newVal);
        },
        ...
        //modified by qy
        _uiSetIsFixed: function(val) {
            var instance = this;

            instance.get('node').toggleClass(CSS_SCHEDULER_EVENT_ISFIXED, !! val);
        },
        
        //modified by qy
        _uiSetIsDone: function(val) {
            var instance = this;

            instance.get('node').toggleClass(CSS_SCHEDULER_EVENT_ISDONE, !! val);
        },
...
var SchedulerCalendar = A.Base.create('scheduler-calendar', A.ModelList, [], {
    ...
    initializer: function() {
        ...
        //modified by qy
        instance.after('isfixedChange', instance._afterIsFixedChange);
        instance.after('isdoneChange', instance._afterIsDoneChange);
        ...
        instance._setModelsAttrs({
            ...
            isFixed: instance.get('isfixed'),//modified by qy
            disDone: instance.get('isdone'),//modified by qy
